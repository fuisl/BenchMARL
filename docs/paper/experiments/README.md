...
| 1331 | `structured_surrogate_1331/` | Gate 0e: planner-induced coverage collection followed by the behavior/full structured physical-surrogate control comparison; running | [`23_planner_coverage_structured_surrogate.md`](23_planner_coverage_structured_surrogate.md) |
