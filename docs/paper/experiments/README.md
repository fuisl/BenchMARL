...
| 1296 | `decision_information_1296/` | Gate 0d frozen seed-4100 panel: shared bank A/B/C/D scoring plus rank agreement across every CEM iteration; running | [`22_decision_information_localization.md`](22_decision_information_localization.md) |
