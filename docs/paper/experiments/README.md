...
| 1506 | `ta2b_localization_1506/` | **T-A2b-2**: adds `latent + ball/linkage state` to decide whether the deficit is the omitted mediating state (world token indicated) or the JEPA abstraction itself. RUNNING | [`30_task_a_counterfactual_fidelity.md`](30_task_a_counterfactual_fidelity.md) |
