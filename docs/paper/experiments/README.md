...
| 1500 | `ta2_fidelity_1500/` | **T-A2 stage 2**: E_CF per Jacobian block for all 48 checkpoints, both probe families. RUNNING | [`30_task_a_counterfactual_fidelity.md`](30_task_a_counterfactual_fidelity.md) |
