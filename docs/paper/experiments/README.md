...
| 1508 | `g0_recoverability_1508/` | **G0 full**: blind floor, raw observation, 3-frame history, physical ceiling, plus per-checkpoint latent / latent+agent-physical / latent+ball. RUNNING | [`32_joint_representation.md`](32_joint_representation.md) |
